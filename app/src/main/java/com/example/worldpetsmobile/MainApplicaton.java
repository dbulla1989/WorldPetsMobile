...
public class MainApplicaton extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.appBarMainApplicaton.fab.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_sedes, R.id.nav_maps_activity)
